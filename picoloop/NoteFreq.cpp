...
void NoteFreq::init()
{
  ...
  for (i=1;i<109;i++)
	...
	*/
	wtjump_freq=(freq*WAVETABLE_SIZE*(wtshift))/44100;	
	...
	wtjump_detune_1=(((this->getFNoteFreq(i+1)*((WAVETABLE_SIZE*(wtshift))/44100))))*j;
	wtjump_detune_2=(((this->getFNoteFreq(i-1)*((WAVETABLE_SIZE*(wtshift))/44100))))*(128-j);
