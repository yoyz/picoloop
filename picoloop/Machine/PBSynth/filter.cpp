...
void PBSynthFilter::setCutoff(mfloat cutoff, mfloat resonance) {
...
void PBSynthFilter::process(mfloat *in, mfloat *out, int n) {
...
void *PBSynthFilter::getParameters(int *size) {
...
mfloat PBSynthFilter::getCutoff() {
	
	return parameters.cutoff;
}

mfloat PBSynthFilter::getResonance() {
