#include "MDADrumUserInterface.h"




MDADrumUserInterface::MDADrumUserInterface()
{
}
...
void MDADrumUserInterface::display_board_text()
{
  int  i;
  char str_up[64];
  char str_down[64];
...
void MDADrumUserInterface::display_board(int menu)
{
...
void MDADrumUserInterface::display_board_amp_env()
{
...
void MDADrumUserInterface::display_board_note()
{
  int  i;
  int  j;
  int  cty=SEQ.getCurrentTrackY();
...
void MDADrumUserInterface::display_board_vco()
{
  int  i;
  int  cty=SEQ.getCurrentTrackY();
  int  step=SEQ.getPatternSequencer(cty).getStep();
...
void MDADrumUserInterface::display_board_osc()
{
  int  i;
  int  cty=SEQ.getCurrentTrackY();
  int  step=SEQ.getPatternSequencer(cty).getStep();
...
void MDADrumUserInterface::display_board_lfo()
{
  int  i;
  int  cty=SEQ.getCurrentTrackY();
  int  step=SEQ.getPatternSequencer(cty).getStep();
...
void MDADrumUserInterface::display_board_fltr()
{
  int  i;
  int  cty=SEQ.getCurrentTrackY();
  int  step=SEQ.getPatternSequencer(cty).getStep();
