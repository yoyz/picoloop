#include "SIDSynthUserInterface.h"




SIDSynthUserInterface::SIDSynthUserInterface()
{
}
...
void SIDSynthUserInterface::handle_key(int menu)
{
  DPRINTF("SIDSynthUserInterface::handle_key(%d,%d)\n",menu);
...
void SIDSynthUserInterface::handle_key_amp_env()
{
...
void SIDSynthUserInterface::handle_key_note()
{
  // GLOBALMENU_NOTE
  // change note
  // copy/paste
...
void SIDSynthUserInterface::handle_key_osc()
{
  // GLOBALMENU_OSC
...
void SIDSynthUserInterface::handle_key_vco()
{
  // GLOBALMENU_VCO
  // VCO Menu
  // Change Value
...
void SIDSynthUserInterface::handle_key_lfo()
{
  // GLOBALMENU_LFO
  // LFO Menu
  // Change Value
...
void SIDSynthUserInterface::handle_key_fltr()
{
  // GLOBALMENU_FLTR
...
void SIDSynthUserInterface::display_board_text()
{
  int  i=0;
  char str_line1[64]="";
  char str_line2[64]="";
...
void SIDSynthUserInterface::display_board(int menu)
{
  DPRINTF("SIDSynthUserInterface::display_board(%d,)\n",menu);
  if (menu==GLOBALMENU_AD) 
...
void SIDSynthUserInterface::display_board_note()
{
  int  i;
  int  j;
  int  cty=SEQ.getCurrentTrackY();
