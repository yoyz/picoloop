...
namespace mopotwytchsynth {
  ...
  void ProcessorRouter::process() {
    ...
    TWYTCH_MOPO_ASSERT(num_processors != 0);
  }
  ...
  void ProcessorRouter::removeProcessor(const Processor* processor) {
    ...
    TWYTCH_MOPO_ASSERT(local_pos != local_order_.end());
  ...
  void ProcessorRouter::removeFeedback(Feedback* feedback) {
    ...
    TWYTCH_MOPO_ASSERT(pos != global_feedback_order_->end());
    ...
    TWYTCH_MOPO_ASSERT(local_pos != local_feedback_order_.end());
