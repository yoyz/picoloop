...
#pragma once
#ifndef TWITCHHELM_HELM_VOICE_HANDLER_H
#define TWITCHHELM_HELM_VOICE_HANDLER_H
...
namespace twytchhelmmopo {
  ...
  class HelmVoiceHandler : public virtual VoiceHandler, public virtual HelmModule {
    ...
    private:
      ...
      Value* mod_wheel_amounts_[twytchhelmmopo::NUM_MIDI_CHANNELS];
      Value* pitch_wheel_amounts_[twytchhelmmopo::NUM_MIDI_CHANNELS];
