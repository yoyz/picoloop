...
#pragma once
#ifndef TWITCHHELM_FIXED_POINT_WAVE_H
#define TWITCHHELM_FIXED_POINT_WAVE_H
  ...
  class FixedPointWave {
    public:
      ...
      static inline mopo_float* getBuffer(int waveform, int phase_inc) {
        int clamped_inc = twytchhelmmopo::utils::iclamp(phase_inc, 1, INT_MAX);
      ...
      static inline int getHarmonicIndex(int phase_inc) {
        ...
        return twytchhelmmopo::utils::iclamp(FixedPointWaveLookup::HARMONICS + 1 - ratio,
