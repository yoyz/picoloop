...
namespace twytchhelmmopo {
  ...
  void Bypass::process() {
    HELM_MOPO_ASSERT(inputMatchesBufferSize());
  ...
  void Add::process() {
    HELM_MOPO_ASSERT(inputMatchesBufferSize(0));
    HELM_MOPO_ASSERT(inputMatchesBufferSize(1));
  ...
  void Interpolate::process() {
    HELM_MOPO_ASSERT(inputMatchesBufferSize(0));
    HELM_MOPO_ASSERT(inputMatchesBufferSize(1));
    HELM_MOPO_ASSERT(inputMatchesBufferSize(2));
  ...
  void VariableAdd::process() {
    ...
    for (int i = 0; i < inputs_->size(); ++i)
      HELM_MOPO_ASSERT(inputMatchesBufferSize(i));
#endif
