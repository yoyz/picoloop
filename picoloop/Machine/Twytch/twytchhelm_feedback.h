...
#pragma once
#ifndef TWITCHHELM_FEEDBACK_H
#define TWITCHHELM_FEEDBACK_H
...
namespace twytchhelmmopo {
  ...
  class Feedback : public Processor {
    public:
      ...
      inline void tickRefreshOutput(int i) {
        HELM_MOPO_ASSERT(i > 0 && i < buffer_size_);
  ...
  namespace cr {
    class Feedback : public ::twytchhelmmopo::Feedback {
      public:
        Feedback() : ::twytchhelmmopo::Feedback(true) { }
    };
  } // namespace cr
} // namespace twytchhelmmopo
