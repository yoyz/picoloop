...
if [ $1 -eq 1 ] ; then
    ...
    for i in main.cpp SampleInstrument.cpp SyncMaster.cpp SamplePool.cpp SampleVariable.cpp Observable.cpp Variable.cpp WatchedVariable.cpp TablePlayback.cpp VariableContainer.cpp Filters.cpp SRPUpdaters.cpp FileSystem.cpp Trace.cpp Config.cpp wildcard.cpp Status.cpp WavFile.cpp Groove.cpp Persistent.cpp TimeService.cpp ServiceRegistry.cpp char.cpp SubService.cpp UnixFileSystem.cpp Result.cpp DEBSystem.cpp Logger.cpp ; do
...
g++  main.o SampleInstrument.o SyncMaster.o SamplePool.o SampleVariable.o Observable.o Variable.o WatchedVariable.o TablePlayback.o VariableContainer.o Filters.o SRPUpdaters.o FileSystem.o Trace.o Config.o  wildcard.o Status.o WavFile.o Groove.o Persistent.o TimeService.o ServiceRegistry.o char.o SubService.o UnixFileSystem.o Result.o DEBSystem.o Logger.o -o main
g++  main3.o SampleInstrument.o SyncMaster.o SamplePool.o SampleVariable.o Observable.o Variable.o WatchedVariable.o TablePlayback.o VariableContainer.o Filters.o SRPUpdaters.o FileSystem.o Trace.o Config.o  wildcard.o Status.o WavFile.o Groove.o Persistent.o TimeService.o ServiceRegistry.o char.o SubService.o UnixFileSystem.o Result.o DEBSystem.o Logger.o -o main3
g++  main4.o SampleInstrument.o SyncMaster.o SamplePool.o SampleVariable.o Observable.o Variable.o WatchedVariable.o TablePlayback.o VariableContainer.o Filters.o SRPUpdaters.o FileSystem.o Trace.o Config.o  wildcard.o Status.o WavFile.o Groove.o Persistent.o TimeService.o ServiceRegistry.o char.o SubService.o UnixFileSystem.o Result.o DEBSystem.o Logger.o -o main4
