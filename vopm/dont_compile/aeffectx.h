...
//-------------------------------------------------------------------------------------------------------
        ...
        audioMasterCloseFileSelector,           ///< [ptr]: VstFileSelect*  @see AudioEffectX::closeFileSeE_VST_DEPRECATED (audioMasterEditFile),           ///< \deprecated deprecated in VST 2.4
...
//-------------------------------------------------------------------------------------------------------
        ...
        , effGetVendorString                                    ///< [ptr]: stMaxVendorStrLen  @see AudioEffectX::getVendorString
        ...
        , effStartProcess                                               ///< no ars                                                ///< no arguments  @see AudioEffectX::stopProcess
...
//-------------------------------------------------------------------------------------------------------
        ...
        kSpeakerArr30Musi70Music,                     ///< L R C Ls  Rs Sl Sr
...
//-------------------------------------------------------------------------------------------------------
/** Platform-independent definition of V-------------------------------
enum VstVirtualKey 
{
//-------------------------------------------------------------------------------------------------------
        VKEY_BACK = 1, 
